...
public class BookDataForEditAndCount {
    ...
    public BookDataForEditAndCount (String Bcode, String onvan, String creator, String pub, String year2, String existnum, String code, String shenase2) {
        this.Bcode = Bcode;
        this.onvan = onvan;
    ...
    private ArrayList<BookDataForEditAndCount > bookDataForEditAndCountlist = new ArrayList<>();
    ...
    public void addBookDataForEditAndCount (BookDataForEditAndCount  bookDataForEditAndCount ) {
